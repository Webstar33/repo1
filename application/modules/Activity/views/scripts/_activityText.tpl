...
<?php
  ...
  <?php if( !$this->noList ): ?><li id="activity-item-<?php echo $action->action_id ?>" class="activity-item" data-activity-feed-item="<?php echo $action->action_id ?>"><?php endif; ?>
	...
	$isuseronline = Engine_Api::_()->adcustommodule()->isuseronline($action->getSubject()->getIdentity());
	
	if($isuseronline) {
		  echo "<span class='ad_green'></span>";
	}else {
		  echo "<span class='ad_grey'></span>";
	}
    ...
    <div class='feed_item_body'>
            ...
            <?php else: ?>
              <li class="feed_item_option_comment">
                ...
                <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Comment'), array(
                    ...
                    'onclick'=>'document.getElementById("'.$this->commentForm->getAttrib('id').'").style.display = ""; document.getElementById("'.$this->commentForm->submit->getAttrib('id').'").style.display = "block";
					document.getElementById("ad_comments_'.$this->commentForm->getAttrib('id').'").style.display = "block";
      ...
      <?php if( $action->getTypeInfo()->commentable ): // Comments - likes ?>
        <div class='comments' id="ad_comments_<?php echo $this->commentForm->getAttrib('id'); ?>" style="display:none;">
          <ul>

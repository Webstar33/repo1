...
<div class='tabs'>
  ...
  <div class='clear'>
    ...
    <form class="global_form">
      <div>
        <h3> <?php echo $this->translate("Game Activity Feed Categories") ?> </h3>
        <p class="description">
          <?php echo $this->translate("ACTIVITY_VIEWS_SCRIPTS_ADMINSETTINGS_CATEGORIES_DESCRIPTION") ?>
        </p>
        <?php if(!empty($this->category)): ?>
            <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'activity', 'controller' => 'categories', 'action' => 'gaming' 
                ...
                <tr class="item_label" data-id="<?php echo $category->category_id; ?>">                  
                  ...
                  <td>
                    <?php if(empty($this->id)): ?>
                        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'activity', 'controller' => 'categories', 'action' => 'gaming', 'id' => $category->category_id), $this->translate("Sub Categories"), array(
                          'class' => '',
                        )) ?>

...
<?php if ($this->resource_type != 'user' && !empty($informationArray) && in_array("sitecontentcoverphoto_cover", $informationArray)) : ?>
    ...
    <?php endif; ?>
<?php elseif ($this->resource_type == 'user' && !empty($informationArray) && in_array("siteusercoverphoto_cover", $informationArray)):
    ?>
            ...
            <div class="info_tip_content <?php if ($setCoverPhoto): ?> info_tip_has_cover <?php endif; ?>">
                ...
                <?php if (strtolower($this->result->getModuleName()) != 'user' && $setCoverPhoto) : ?>
                    <?php if ($coreModules->isModuleEnabled('sitecontentcoverphoto')): ?>	
                        <div class="info_tip_cover_photo_wrapper">
                            ...
                            <?php if ($photo): ?>
                                <?php
                                $modulename = strtolower($this->result->getModuleName());
                                if ($modulename != 'album') {
                                ...
                                <div class="info_tip_cover_photo ">
                                    <a href="<?php echo $photo->getHref(); ?>" onclick='openSeaocoreLightBox("<?php echo $photo->getHref(); ?>");
                                                        return false;'>
                ...
                <div class="tip_main_photo">
                    ...
                    <?php if ($this->resource_type == 'user') : ?>
                        ...
                        <?php endif; ?>
                        <?php
                    elseif ($this->resource_type == 'blog' || $this->resource_type == 'forum_topic' ||
                    ...
                    <?php elseif (!empty($this->result->image_url) && ($this->resource_type == 'sitemagento_product')): ?>
                        <a href="<?php echo $this->result->url; ?>"><i class="thumb_icon" style="background-image:url('<?php echo $this->result->image_url ?>');"></i></a>
                    <?php else: ?>
                ...
                <div class="tip_main_body">
                        ...
                        <?php if (!empty($informationArray) && in_array("joingroupfriend", $informationArray)) : ?>
                            <div class="tip_main_body_stat" style="margin-top:7px;">
                                <?php if (!empty($this->friendLikeCount)) { ?>
                                    <a href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('module' => 'seaocore', 'controller' => 'feed', 'action' => 'common-member-list', 'resouce_type' => $this->resource_type, 'resource_id' => $this->resource_id, 'format' => 'smoothbox'), 'default', true)); ?>');
                                                        return false;" ><?php echo $this->translate(array('%s friend is member', '%s friends are members', $this->friendLikeCount), $this->friendLikeCount); ?> </a>
                    ...
                    <?php } elseif (($this->resource_type == 'event' || $this->resource_type == 'siteevent_event')) { ?>
                        ...
                        <?php if ($showMemberCount && !empty($informationArray) && in_array("attendingeventfriend", $informationArray)) : ?>
                            <div class="tip_main_body_stat" style="margin-top:7px;">
                                <?php if (!empty($this->friendLikeCount)) { ?>
                                    <a href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('module' => 'seaocore', 'controller' => 'feed', 'action' => 'common-member-list', 'resouce_type' => $this->resource_type, 'resource_id' => $this->resource_id, 'format' => 'smoothbox'), 'default', true)); ?>');
                                                        return false;" ><?php echo $this->translate(array('%s friend is attending', '%s friends are attending', $this->friendLikeCount), $this->friendLikeCount); ?> </a>
                    ...
                    <?php } elseif ($this->resource_type == 'user') { ?>
                        ...
                        <?php if (!empty($this->muctualfriendLikeCount) && ($this->resource_id != $this->viewer_id) && !empty($informationArray) && in_array("mutualfriend", $informationArray)) { ?>
                            <div class="tip_main_body_stat" style="margin-top:7px;">
                                <a href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('module' => 'seaocore', 'controller' => 'feed', 'action' => 'more-mutual-friend', 'id' => $this->resource_id, 'format' => 'smoothbox'), 'default', true)); ?>');
                                                return false;" ><?php echo $this->translate(array('%s mutual friend', '%s mutual friends', $this->muctualfriendLikeCount), $this->muctualfriendLikeCount); ?>		</a>
                            </div>
                        <?php } ?>
                    <?php } else { ?>
                        ...
                        <div class="tip_main_body_stat">
                            <?php
                            if (!empty($this->likeCount) && !empty($informationArray) && in_array("like", $informationArray))
                                echo $this->translate(array('%s likes this', '%s like this', $this->likeCount), $this->likeCount)
                                ?>
                        </div>
                        <div class="tip_main_body_stat" style="margin-top:7px;">
                            <?php
                            if (!empty($this->friendLikeCount) && !empty($informationArray) && in_array("friendcommon", $informationArray)) {
                                ?>
                                <a href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('module' => 'seaocore', 'controller' => 'feed', 'action' => 'common-member-list', 'resouce_type' => $this->resource_type, 'resource_id' => $this->resource_id, 'format' => 'smoothbox'), 'default', true)); ?>');
                                                return false;" ><?php echo $this->translate(array('%s friend likes this', '%s friends like this', $this->friendLikeCount), $this->friendLikeCount); ?>
                                </a>
                ...
                $this->friendLikeCount), $this->friendLikeCount);-->
                    ...
                    <?php } ?>
                    <?php
                    if ($this->resource_type == 'user' && ($this->resource_id != $this->viewer_id) &&
                        ...
                        <?php endif; ?>
                        <?php
                    } elseif ($this->resource_type != 'user' && !empty($informationArray) &&
            ...
            <?php if ($this->resource_type == 'user') { ?>
                ...
                if (!empty($this->pokeEnabled) && (!empty($this->getpokeFriend)) && ($this->resource_id !=
                    ...
                    <?php if (!$flag) : ?>
                        ...
                        ?>
                        <a class="seaocore_poke" href="javascript:void(0);" onclick="showSmoothBox('<?php
                        ...
                        ?>');
                                        return false;" style="background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Poke/externals/images/poke_icon.png);"><?php echo $this->translate("Poke") ?></a>
                       <?php } //END POKE WORK.  ?>
                    ...
                    if (!empty($this->suggestionEnabled) && !empty($this->getMemberFriend) &&
                        ...
                        <?php if (!$flag) : ?>
                            ...
                            ?>
                            <a class="seaocore_suggest" href="javascript:void(0);" onclick="showSmoothBox('<?php
                            ...
                            ?>');
                                            return false;" style="background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Suggestion/externals/images/sugg_blub.png);"><?php echo $this->translate("Suggest to Friends") ?></a>
                           <?php } //END SUGGESTION WORK. ?>

                        <?php
                        //FOR MESSAGE LINK
                        $item = Engine_Api::_()->getItem('user', $this->resource_id);
                        if (!empty($info_values) && in_array("message", $info_values) && (Engine_Api::_()->seaocore()->canSendUserMessage($item)) &&
                            ...
                            <?php if (!$flag) : ?>
                                ...
                                <?php if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('primemessenger') && Engine_Api::_()->primemessenger()->isPrimeMessengerActive()) : ?>
                                    <a onClick="window.pm.openChatBox(<?php echo $this->resource_id ?>);" class="buttonlink primemessenger_icon" href="javascript:void(0)"><?php echo $this->translate('Message'); ?></a>
                                <?php else : ?>
                            ...
                            <?php } ?>
                            <?php
                            if (!empty($info_values) && in_array("addfriend", $info_values) &&
                                    (!empty($this->viewer_id))):
                                ?>
                            ...
                            <?php
                            if (!empty($this->suggestionEnabled) && ($this->resource_type != 'user') &&
                                ...
                                <?php if (!empty($this->viewer_id) && (!empty($info_values) && in_array("review_wishlist", $info_values)) && !empty($this->listingtypeArray->wishlist) && $this->resource_type == 'sitereview_listing') : ?>
                                    <?php if (!$flag) : ?>
                                        <div class="info_tip_content_bottom">
                                            <?php $flag = true; ?>
                                        <?php endif; ?>
                                        <a class="seaocore_wishist" href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('route' => 'sitereview_wishlist_general', 'module' => 'sitereview', 'controller' => 'wishlist', 'action' => 'add', 'listing_id' => $this->resource_id), 'default', true)); ?>');
                                                    return false;" style="background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitereview/externals/images/icons/wishlist_add.png);"><?php echo $this->translate('Add to Wishlist'); ?></a>
                                       <?php elseif (!empty($this->viewer_id) && (!empty($info_values) && in_array("storeproductreview_wishlist", $info_values)) && $this->resource_type == 'sitestoreproduct_product') : ?>
                                           <?php if (!$flag) : ?>
                                            <div class="info_tip_content_bottom">
                                                <?php $flag = true; ?>
                                            <?php endif; ?>
                                            <a href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('action' => 'add', 'product_id' => $this->resource_id), 'sitestoreproduct_wishlist_general', true)); ?>');
                                                        return false;" style="background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitestoreproduct/externals/images/icons/wishlist.png);"><?php echo $this->translate('Add to Wishlist'); ?></a>
                                           <?php endif; ?>
                                        ...
                                        <?php if ((!empty($info_values) && in_array("joinpage", $info_values)) && !empty($this->joinFlag) && $this->resource_type == 'sitepage_page' && !empty($this->member_approval)) : ?>
                                            <?php if (!$flag) : ?>
                                                <div class="info_tip_content_bottom">
                                                    <?php $flag = true; ?>
                                                <?php endif; ?>
                                                <a class="seaocore_joinpage" href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('route' => 'sitepage_profilepagemember', 'module' => 'sitepagemember', 'controller' => 'member', 'action' => 'join', "page_id" => $this->resource_id), 'default', true)); ?>');
                                                            return false;" style="background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepagemember/externals/images/member/join.png);"><?php echo $this->translate("Join Page"); ?></a>
                                               <?php endif; ?>
                                            ...
                                            <?php if ((!empty($info_values) && in_array("requestpage", $info_values)) && !empty($this->requestFlag) && $this->resource_type == 'sitepage_page' && empty($this->member_approval)) : ?>
                                                <?php if (!$flag) : ?>
                                                    <div class="info_tip_content_bottom">
                                                        <?php $flag = true; ?>
                                                    <?php endif; ?>
                                                    <a class="seaocore_request" href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array('route' => 'sitepage_profilepagemember', 'module' => 'sitepagemember', 'controller' => 'member', 'action' => 'request', "page_id" => $this->resource_id), 'default', true)); ?>');
                                                                return false;" style="background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepagemember/externals/images/member/join.png);"><?php echo $this->translate('Request Member for Page'); ?></a>
                                                   <?php endif; ?>
...
//FOR SHARE LINK.
                                                if (!empty($this->viewer_id) && ($this->resource_type != 'user') && ($this->resource_type != 'siteevent_event') && ($this->resource_type != 'forum_post') && ($this->resource_type != 'forum_topic') && ($this->resource_type != 'album') && !empty($info_values) && in_array("share", $info_values)):
                                                    ...
                                                    <?php if (!$flag) : ?>
                                                        ...
                                                        ?>
                                                        <a class="seaocore_share" href="javascript:void(0);" onclick="showSmoothBox('<?php
                                                        echo
                                                        $this->escape($this->url(array('module' => 'advancedactivity', 'controller' => 'index', 'action' =>
                                                                    'share', 'type' => $this->resource_type, 'id' => $this->resource_id, 'format' => 'smoothbox'), 'default', true));
                                                        ?>');
                                                                    return false;" style="background-image:

...
('core_main_home', 'core', 'Home', 'User_Plugin_Menus', '{"icon":"fa-home"}', 'core_main', '', 1),
...
('core_mini_admin', 'core', 'Admin', 'User_Plugin_Menus', '', 'core_mini', '', 2),
('core_mini_profile', 'user', 'My Profile', 'User_Plugin_Menus', '', 'core_mini', '', 3),
('core_mini_settings', 'user', 'Settings', 'User_Plugin_Menus', '', 'core_mini', '', 5),
...
('core', 'Core', 'The Alpha and the Omega.', '4.8.13', 1, 'core');

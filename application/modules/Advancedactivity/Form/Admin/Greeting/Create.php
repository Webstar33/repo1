...
class Advancedactivity_Form_Admin_Greeting_Create extends Engine_Form {
  public function init() {
    ...
    $this
      ...
      ->setDescription('You can add a greeting / gnnouncement for your users. Decorate the greeting / announcement with TINYMCE editor and set the duration and time for the greeting / announcement to be visible to users.')

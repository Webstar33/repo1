...
<div class='sd_feed_header'>
    <div class='sd_feed_headersection sd_feed_mostpopular'>
        <a href='javascript:void(0);' class="sd_active_pouplar" onclick='loadPopularFeed(this);'><?php echo $this->translate("Most Popular"); ?></a>
        <ul>
            <li class='active'>
                <a href='javascript:void(0);' onclick='activateFeedOptions(this);loadPopularFeed(this);'><?php echo $this->translate("Most Popular"); ?></a>
            </li>
            <li>
    ...
    <div class='sd_feed_headersection sd_feed_options'>
        <a href='javascript:void(0);' onclick='loadAllFeed(this);'><?php echo $this->translate("All"); ?></a>        
    </div>
</div>
<script type='text/javascript'>
...
function showLocationFilter(element){
    ...
    if(latLong){
        ...
        elem.setAttribute("style","position: relative; height: 270px; width: 270px; overflow: hidden;" );
    }else{
        var map = new google.maps.Map(document.getElementById('map'), {
            zoom: 10,
        ...
        var elem = document.getElementById('map');
        elem.setAttribute("style","position: relative; height: 270px; width: 270px;" );
    }
}
...
function loadLocationFeed(element){
    ...
    window.mostLocationFeedFilter = $("locationParams").value;
    ...
    var request = new Request.HTML({
          ...
          data : {
            ...
            'locationParams': window.mostLocationFeedFilter
          },
          evalScripts : true,
          onRequest: function(){

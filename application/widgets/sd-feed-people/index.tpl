...
<div class='sd_feed_header'>
    <div class='sd_feed_headersection sd_feed_mostpopular'>
        <a href='javascript:void(0);' class="sd_active_pouplar" onclick='loadPopularFeed(this);'><?php echo $this->translate("People"); ?></a>
        <ul>
            <li class='active'>
                <a href='javascript:void(0);' onclick='activateFeedOptions(this);loadPopularFeed(this);'><?php echo $this->translate("People"); ?></a>
            </li>
            <li>

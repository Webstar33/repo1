...
class Widget_SdFeedMusicController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    //print_r($this->view->allCategories);die;
    ...
    $this->view->category_id = $request->getParam("category_id", $categoryId);
    $this->view->subcategory_id = $request->getParam("subcategory_id",0);
//echo $this->view->category_id; die;
    if( $feedOnly ) {

...
<div class='sd_feed_header'>
    <div class='sd_feed_headersection sd_feed_mostpopular'>
        <a href='javascript:void(0);' class="sd_active_pouplar" onclick='loadPopularFeed(this);'><?php echo $this->translate("Music"); ?></a>
        <ul>
            <li class='active'>
                <a href='javascript:void(0);' onclick='activateFeedOptions(this);loadPopularFeed(this);'><?php echo $this->translate("Music"); ?></a>
            </li>
            <li>
...
<div class="sd_feed_filters" id="sd_feed_filters">
    <?php if(count($this->allCategories)): ?>
        <ul class="sd_feed_categories">
            <li class="active">
                <a href="javascript:void(0);" onclick="filterFeedCategory(this,'<?php echo $this->category_id; ?>','');"><?php echo $this->translate("All"); ?></a>                
            </li>
        <?php foreach($this->allCategories as $key => $category): ?>
            <?php //if( $key < 7 ): ?>
                <li class="<?php if(!empty($category['sub_categories'])){ echo 'has_subcategories';  } ?>">
                    <a href="javascript:void(0);" onclick="filterFeedCategory(this,'<?php echo $this->category_id; ?>','<?php echo $category['id']; ?>');"><?php echo $category['title']; ?></a>
                </li>
            <?php //endif;?>
        <?php endforeach; ?>

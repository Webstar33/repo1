    ...
    en4.core.runonce.add(function(){
       ...
       function showPreview(image,bgcolor,color){
           if(!$('preview_banner')) { 
                ...
                div.setStyles({ 'background': '#09e89e','color':'#ffffff','padding':'110px 30px','float' : 'right','width': '67%','background-size': 'cover','text-align':'center','box-sizing':'border-box','font-size':'25px','font-weight':'bold','margin-top':'-35px'});

              	...
              	<table>
              		<tr>
              			<td>
			                ...
			                <?php //echo $this->htmlLink('https://maps.google.com/?q=' . urlencode($this->checkin['label']), $this->translate('&nbsp;'), array('target' => '_blank', 'class'=> 'sdf', 'title' => $this->translate('See on Google Maps'))) ?>
			              </td>
			              <td>
          ...
          <table>
            ...
            <tr>
              ...
              <td>
	              ...
	              <?php //echo $this->htmlLink('https://maps.google.com/?q=' . urlencode($lable), $this->translate('&nbsp;'), array('target' => '_blank', 'class'=> 'sdf', 'title' => $this->translate('See on Google Map'))) ?>
	            </td>
	<!--			              <td>
	            	<a href="<?php //echo 'https://maps.google.com/?q=' . urlencode($lable); ?>" class="seaocore_map_tip" target="_blank">
	        				<p class="seaocore_map_tip_content"><?php //echo $this->translate('See on Google Maps'); ?></p>

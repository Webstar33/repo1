...
<div class="contest_page_wrapper">
    ...
    <div class='sd_feed_header'>
		<div class='sd_feed_headersection sd_feed_mostpopular'>
			<a href='javascript:void(0);' class="sd_active_pouplar"><?php echo $this->translate("Hot"); ?></a>
			<ul>
			<li class='active'>
			<a href='javascript:void(0);'><?php echo $this->translate("Hot"); ?></a>
			</li>
			<li>
	...
	<div class="ad_contest_top_section">
		...
		<ul class="ad_contest_ul">
          <li class="ad_contest_li">
			<div class="ad_contest_image">
			    <img src="/application/modules/Activity/externals/images/contest/con_img_1.jpg" />
			</div>
		...
		<div class="ad_contest_links">
			<a href="javascript:void(0);" class="ad_content_vote">Hot or Not</a>
        </div> 

...
<div class="store_page_wrapper">
    ...
    <div class='sd_feed_header'>
		<div class='sd_feed_headersection sd_feed_mostpopular'>
			<a href='javascript:void(0);' class="sd_active_pouplar"><?php echo $this->translate("Shop"); ?></a>
			<ul>
			<li class='active'>
			<a href='javascript:void(0);'><?php echo $this->translate("Shop"); ?></a>
			</li>
			<li>
		...
		<ul class="ad_store_ul">
		  ...
		  <?php $href = $this->url(array('module' => 'adcustommodule', 'controller' => 'index', 'action' => 'tournament')); ?>
			<div class="ad_store_image">
			    <a href="/pages/featuredmembers"><img src="/application/modules/Activity/externals/images/store/1.jpeg" /></a>
			</div>
			<div class="ad_store_info">
			    <h3 class="ad_store_title"> <a href="/pages/featuredmembers">Demo/This is a Demo </a></h3>
				<p class="ad_store_desc">
					<span class="ad_content_username"> <a href="#">Webstar Ent.</a> </span>
					<span class="ad_content_category"> <a href="#">Special Offer,Shop</a></span>
				</p>	
			</div>
		  </li>
          <li class="ad_store_li">
			<div class="ad_store_image">
			     <img src="/application/modules/Activity/externals/images/store/2.jpg" />
			</div>
			<div class="ad_store_info">
			    <h3 class="ad_store_title"> <a href="#">Demo/This is a Demo </a></h3>
				<p class="ad_store_desc">
					<span class="ad_content_username"> <a href="#">Webstar Ent.</a> </span>
					<span class="ad_content_category"> <a href="#">Special Offer,Shop</a></span>
				</p>	
		  ...
		  <li class="ad_store_li">
			<div class="ad_store_image">
			     <img src="/application/modules/Activity/externals/images/store/3.png" />
			</div>
			<div class="ad_store_info">
			    <h3 class="ad_store_title"> <a href="#">Demo/This is a Demo </a></h3>
				<p class="ad_store_desc">
		  ...
		  <li class="ad_store_li">
			<div class="ad_store_image">
			    <img src="/application/modules/Activity/externals/images/store/4.jpg" />
			</div>
			<div class="ad_store_info">
			    <h3 class="ad_store_title"> <a href="#">Demo/This is a Demo </a></h3>
				<p class="ad_store_desc">
		  ...
		  <li class="ad_store_li">
			<div class="ad_store_image">
			     <img src="/application/modules/Activity/externals/images/store/5.png" />
			</div>
			<div class="ad_store_info">
			    <h3 class="ad_store_title"> <a href="#">Demo/This is a Demo </a></h3>
				<p class="ad_store_desc">
		  ...
		  <li class="ad_store_li">
			<div class="ad_store_image">
			     <img src="/application/modules/Activity/externals/images/store/6.jpg" />
			</div>
			<div class="ad_store_info">
			    <h3 class="ad_store_title"> <a href="#">Demo/This is a Demo </a></h3>
				<p class="ad_store_desc">
	...
	<div class="ad_store_bottom_section">
		...
		<ul class="ad_store_ul">
          <li class="ad_store_li">
			<div class="ad_store_image">
			    <img src="/application/modules/Activity/externals/images/store/1.jpeg" />
			</div>
			<div class="ad_store_info">
			    <h3 class="ad_store_title"> <a href="#">Demo/This is a Demo </a></h3>
				<p class="ad_store_desc">
					<span class="ad_content_username"> <a href="#">Webstar Ent.</a> </span>
					<span class="ad_content_category"> <a href="#">Music,Shop</a></span>
				</p>		
			</div>
		  </li>
          <li class="ad_store_li">
			...
			<div class="ad_store_info">
				...
				<p class="ad_store_desc">
					<span class="ad_content_username"> <a href="#">Webstar Ent.</a> </span>
					<span class="ad_content_category"> <a href="#">Sports,Shop</a></span>
				</p>		
			</div>
		  </li>
		  <li class="ad_store_li">
			...
			<div class="ad_store_info">
				...
				<p class="ad_store_desc">
					<span class="ad_content_username"> <a href="#">Webstar Ent.</a> </span>
					<span class="ad_content_category"> <a href="#">Photo,Shop</a></span>
				</p>		
			</div>
		  </li>
		  <li class="ad_store_li">
